//
//  LDXMyForumViewController.swift
//  LDX_SwiftBase
//
...
class LDXMyForumViewController: BaseViewController,UITableViewDelegate,UITableViewDataSource,LDXForumTopViewDelegate {

    private let MY_FORUM_TABLE_CELL:String = "MY_FORUM_TABLE_CELL"
    ...
    func setUpForumView() {
        ...
        myForumButton.setTitle("我要发帖", for: .normal)
        ...
        table.register(LDXForumTableViewCell.self, forCellReuseIdentifier: MY_FORUM_TABLE_CELL)
    ...
    @objc func handleClickSendButton() {
        let sendForumVC:LDXSendForumViewController = LDXSendForumViewController()
        self.navigationController?.pushViewController(sendForumVC, animated: true)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:LDXForumTableViewCell = tableView.dequeueReusableCell(withIdentifier: MY_FORUM_TABLE_CELL, for: indexPath) as! LDXForumTableViewCell
        return cell
    }
    
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return tableView.fd_heightForCell(withIdentifier: MY_FORUM_TABLE_CELL, cacheBy: indexPath) { (cell) in
